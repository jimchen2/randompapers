...
def light_color(color: SpaceDebugColor):
    ...
    return SpaceDebugColor(r=color[0], g=color[1], b=color[2], a=color[3])
    ...
    def draw_fat_segment(
        ...
        if r > 2:
            ...
            if orthog[0] == 0 and orthog[1] == 0:
                return
            scale = radius / (orthog[0] ** 2 + orthog[1] ** 2) ** 0.5
...
class PushTEnv(gym.Env):
    ...
    def teleop_agent(self):
        ...
        def act(obs):
            ...
            if (
                self.teleop
                or (mouse_position - self.agent.position).length < 30
            ):
                self.teleop = True
    ...
    def _render_frame(self, mode):
        ...
        if self.render_action and (self.latest_action is not None):
            ...
            cv2.drawMarker(
                ...
                markerSize=int(8 / 96 * self.render_size),
    ...
    def add_tee(
        ...
        inertia = pymunk.moment_for_poly(
            mass, vertices1
        ) + pymunk.moment_for_poly(mass, vertices1)
...
if __name__ == "__main__":
    ...
    print("Running Push-T simulation. Move mouse over the blue circle to drag.")
    while running:
